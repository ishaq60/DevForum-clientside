...
const Register = () => {
  ...
  const { createUser, signInWithGoogle, updateUserProfile,signInWithGithub } = useAuth();
                ...
                <div className="w-full max-w-md space-y-8 px-4 bg-white text-gray-600 sm:px-0">
                    ...
                    <div className="grid grid-cols-3 gap-x-3">
                        <button onClick={handleGoogleLogin} className="flex items-center justify-center py-2.5 border rounded-lg hover:bg-gray-50 duration-150 active:bg-gray-100">
                         ...
                         <button onClick={handalegithub} className="flex items-center justify-center py-2.5 border rounded-lg hover:bg-gray-50 duration-150 active:bg-gray-100">
                            <svg className="w-5 h-5 z-50" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
