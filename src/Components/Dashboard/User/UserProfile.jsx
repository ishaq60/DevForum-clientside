...
const UserProfile = () => {
  ...
  return (
    <div className="bg-gray-50 m-10 justify-center items-center min-h-screen">
      {/* Top Navigation */}
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-xl shadow-sm overflow-hidden mb-6">
          ...
          <div className="p-6 pt-0 relative">
            <div className="absolute -top-16 left-6 w-32 h-32 rounded-full border-4 border-white bg-white shadow-md flex items-center justify-center overflow-hidden">
              {suser?.image ? (
                <img
                  src={suser.image}
                  alt={suser.name}
