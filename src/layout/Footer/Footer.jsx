        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <div className="grid grid-cols-2 gap-8 sm:grid-cols-3">
              <div>
                ...
                <div className="mt-4 space-y-4">
                  <a href="#" className="text-base text-gray-300 hover:text-white block">Documentation</a>
                  <a href="#" className="text-base text-gray-300 hover:text-white block">Tutorials</a>
              ...
              <div>
                ...
                <div className="mt-4 space-y-4">
                  ...
                  <a href="#" className="text-base text-gray-300 hover:text-white block">Terms</a>
                  <a href="#" className="text-base text-gray-300 hover:text-white block">Cookie Policy</a>
                </div>
              </div>
            </div>
          </div>
          <div className="mt-8 border-t border-gray-700 pt-8 md:flex md:items-center md:justify-between">
            ...
            <p className="mt-8 text-base text-gray-400 md:mt-0 md:order-1">
              &copy; 2025 DevForum. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
